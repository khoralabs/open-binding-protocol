...
React UI: install from the [`khoralabs/react`](https://github.com/khoralabs/react) registry (`bunx shadcn@latest add khoralabs/react/obp`). Graph types: `NbcChainGraph` / `collectNbcChainGraph` on `@khoralabs/obp-nbc`.
