...
/// while each runs **`khora.obp#ObpPersistence`** locally. **`khora.obp`** **`docs/spec/model/shapes.smithy`** / **`docs/spec/persistence/persistence.smithy`** MUST NOT
